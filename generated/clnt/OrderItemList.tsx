...
export class OrderItemView extends React.Component<any, any> {
  ...
  render() {
    ...
    //   record={this.props.OrderItemOrders}/>
  }
}

export class OrderItemEdit extends React.Component<any, any> {
  ...
  async componentDidMount() {
    if (this.props.params.id) {
      try {
        this.setState({
          record: await DataService.loadById('orderItems',
