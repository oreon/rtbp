...
export class AppUserList extends React.Component<any, any> {
 ...
 render() {
    ...
    return (
      ...
      <div>
         {  (records.length > 0 ) &&
        <SimpleList headers= {appUserHeaders} editLink={'AppUserEdit'}
...
export class AppUserView extends React.Component<any, any> {
  ...
  render() {
    ...
    //   record={this.props.AppUserOrders}/>
  }
}
...
export class AppUserEdit extends React.Component<any, any> {
  ...
  async componentDidMount() {
    if (this.props.params.id) {
      try {
        this.setState({
          record: await DataService.loadById('appUsers',
